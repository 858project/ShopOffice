...
namespace ShopOffice.Validations
{
    ...
    /// </summary>
    public sealed class UInt64ValidationRule : ValidationRule
    {
        #region - Properties -
        /// <summary>
        /// Max value for amount
        /// </summary>
        public UInt64 MaxValue { get; set; }
        /// <summary>
        /// Min value for amount
        /// </summary>
        public UInt64 MinValue { get; set; }
        #endregion
        ...
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            // get string value
            UInt64 currentValue = 0x00;
            if (!UInt64.TryParse(value as String, out currentValue))
            {
                return new ValidationResult(false, "Value is not valid");
            }
